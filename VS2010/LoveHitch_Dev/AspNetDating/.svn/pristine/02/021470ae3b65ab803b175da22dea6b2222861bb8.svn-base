<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbuseReports.aspx.cs" Inherits="AspNetDating.Admin.AbuseReports" %>
...
<html>
<HEAD  runat="server">
	<title> <%= Lang.TransA("Abuse Reports") %></title>
    ...
    <div>
		...
		<div id="layout">
			<div id="crupms">
				...
				<div id="crumpstxt"> <%= Lang.TransA("Abuse Reports") %></div>
			</div>
			<div id="sidebar">
		    ...
		    <div id="main">
				<div id="content-head">
					<div class="ch-head"><%= Lang.TransA("Abuse Reports") %></div>
					<div class="ch-description"><%= Lang.TransA("Use this section to view reported abuses...")%></div>
				</div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn>
                                ...
                                <ul>
                                    ...
                                    <li runat="server" Visible='<%# (AbuseReport.ReportType)Eval("ReportType") == AbuseReport.ReportType.Message %>' >
                                    ...
                                    <li runat="server" Visible='<%# (AbuseReport.ReportType)Eval("ReportType") == AbuseReport.ReportType.Photo %>'>
