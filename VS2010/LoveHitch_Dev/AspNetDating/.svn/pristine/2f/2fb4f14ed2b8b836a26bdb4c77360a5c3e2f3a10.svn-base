...
namespace AspNetDating.Classes
{
    ...
    {
        public static Func<AspNetDatingDataContext, string, string, string>
            FetchDisplayedName =
                CompiledQuery.Compile(
                    (AspNetDatingDataContext dbContext, string viewerUsername, string viewedUsername) =>
        ...
        public static Func<AspNetDatingDataContext, long?, IQueryable<string>>
         FetchUsernameByFacebookId =
             CompiledQuery.Compile((AspNetDatingDataContext dbContext, long? fbId) =>
                    dbContext.Users.Where(u => u.u_facebookid == fbId)
                                   .Select(u => u.u_username).Distinct());

        public static Func<AspNetDatingDataContext, string, IQueryable<string>>
         FetchFriendshipAcceptedByUsernames =
             CompiledQuery.Compile((AspNetDatingDataContext dbContext, string username) =>
        ...
        public static Func<AspNetDatingDataContext, string, string, DateTime>
         FetchFriendshipRequestTimeStamp =
             CompiledQuery.Compile((AspNetDatingDataContext db, string fUsername, string uUsername) =>
        ...
        public static Func<AspNetDatingDataContext, string, IQueryable<string>>
         FetchFriendshipRequestsBySpecificUsername =
             CompiledQuery.Compile((AspNetDatingDataContext db, string username) =>
                    (from u in db.Users
        ...
        public static Func<AspNetDatingDataContext, string, IQueryable<Friend>>
        ...
        public static Func<AspNetDatingDataContext, int, IQueryable<Friend>>
            FetchActiveFriendsByBirthday =
                CompiledQuery.Compile((AspNetDatingDataContext db, int daysForward) =>
                              (from f in db.Friends
        ...
        public static Func<AspNetDatingDataContext, string, string, IQueryable<Friend>>
            FetchFriendsSearchResultByUsername =
                CompiledQuery.Compile((AspNetDatingDataContext db, string username, string friendUsername) =>
                                       from f in db.Friends
        ...
        public static Func<AspNetDatingDataContext, string, BasicFriendsSearch, IQueryable<Friend>>
            FetchBasicFriendsSearchResultFiltered =
                CompiledQuery.Compile((AspNetDatingDataContext db, string username, BasicFriendsSearch basicFriendsSearch) =>
                                       from f in db.Friends
        ...
        public static Func<AspNetDatingDataContext, NewUsersSearch, IOrderedQueryable<Model.User>>
            FetchUsersForNewUsersSearchResult =
                CompiledQuery.Compile((AspNetDatingDataContext db, NewUsersSearch newUsersSearch) =>
                                      from u in db.Users
                                      where
        ...
        public static Func<AspNetDatingDataContext, string, Model.User>
            FetchUserByUsername =
                CompiledQuery.Compile((AspNetDatingDataContext db, string username) =>
                                      db.Users.Where(u => u.u_username == username).SingleOrDefault());

        public static Func<AspNetDatingDataContext, IQueryable<string>>
         FetchFacebookUsernamesWithoutPhoto =
             CompiledQuery.Compile((AspNetDatingDataContext db) =>
                    from u in
                        (from u in db.Users
        ...
        public static Func<AspNetDatingDataContext, string, string, IQueryable<string>>
         FetchViewersUsernamesForProfileViewedSearch =
             CompiledQuery.Compile((AspNetDatingDataContext db, string username, string excludeUsername) =>
                    db.ProfileViews
