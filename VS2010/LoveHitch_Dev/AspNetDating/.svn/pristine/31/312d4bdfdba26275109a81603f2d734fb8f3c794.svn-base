...
namespace AspNetDating.Classes
{
    ...
    public class TipPopup //: ISerializable
    {
        ...
        public int Save()
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                ...
                {
                    SqlHelper.ExecuteNonQuery(conn, "SaveTip", _id, _key, _languageId, _showTimes, _loginCountTrigger, _daysCountTrigger,
                ...
                else
                {
                    ...
                    {
                        object scalar = SqlHelper.ExecuteScalar(conn, "CreateTip", lang.Id, _showTimes, _loginCountTrigger, _daysCountTrigger,
        ...
        public static void Delete(string key)
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.ExecuteNonQuery(conn, "DeleteTip", key);
            }
        }
    ...
    public class UserTipStatus
    {
        ...
        public int Save()
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                object result = SqlHelper.ExecuteScalar(conn, "SaveUserTipStatus", TipId, Username, ViewedTimes, IsBlocked, LastViewedDate);
