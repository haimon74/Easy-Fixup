...
using Language = AspNetDating.Classes.Language;
using Translation = AspNetDating.Classes.Translation;

namespace AspNetDating
{
    public class Global : HttpApplication, IHttpApplicationUserAdapter, IHttpApplicationSupportAvatars,
                          ...
                          IHttpApplicationConnectionStringProvider, IHttpApplicationSupportPhotos
    {
        ...
        protected void Application_Start(Object sender, EventArgs e)
        {
            ...
            //SqlDependency.Start(ConfigurationManager.ConnectionStrings["aspnetdating"].ConnectionString);
            Global.AppBackgroundWorkersDic = new Dictionary<string, LovehitchBackgroundWorker>();
            var bgWorker0 = new UpdateFacebookFriendsDataBackgroundWorker(HttpContext.Current);
            LovehitchBackgroundWorker.StartBackgroundWorker(bgWorker0);
            var bgWorker1 = new AddNewFacebookFriendsBackgroundWorker(HttpContext.Current);
            LovehitchBackgroundWorker.StartBackgroundWorker(bgWorker1);
            var bgWorker2 = new FetchDbImageToCacheDirectoryBackgroundWorker(HttpContext.Current);
            LovehitchBackgroundWorker.StartBackgroundWorker(bgWorker2);
            //LovehitchBackgroundWorker.StartBackgroundWorker(new LoadAndSaveFacebookImageBackgroundWorker());
        }
        protected void Session_Start(Object sender, EventArgs e)
        {
            ...
            Session["MatchmakingRequestedDic"] = new Dictionary<string, List<string>>();
            Session["SearchResults_GridMode"] = false;
            FacebookHelper.SessionClear("default.aspx");
            Session["SessionTimeout"] = 10;
            Session["AsyncWorkList"] = new List<IWorkThreadClass>();
        ...
        public static void AddCacheItem(string tableName, string cacheKey, object value)
        {
            ...
            try
            {
                tableDependency = new SqlCacheDependency("LoveHitch20111011", tableName);
            }
            ...
            catch (DatabaseNotEnabledForNotificationException exDBDis)
            {
                try
                {
                    SqlCacheDependencyAdmin.EnableNotifications("LoveHitch20111011");
                }
            ...
            catch (TableNotEnabledForNotificationException exTabDis)
            {
                try
                {
                    SqlCacheDependencyAdmin.EnableTableForNotifications("aspnetdating", tableName);
                }
        ...
        protected void Application_EndRequest(Object sender, EventArgs e)
        {
            try
            {
                //SqlDependency.Stop(ConfigurationManager.ConnectionStrings["aspnetdating"].ConnectionString);
        ...
        protected void Application_End(Object sender, EventArgs e)
        {
            ...
            //((Dictionary<string, LovehitchBackgroundWorker>)HttpContext.Current.Application["BackgroundWorkersDic"]);
            foreach (var bgWorkerItem in workerDic)
            {
                LovehitchBackgroundWorker.StopBackgroundWorker(bgWorkerItem.Value);
            }
        ...
        {
            if (HttpContext.Current != null && HttpContext.Current.Session["UserSession"] != null)
            {
                UserSession sess = (UserSession)HttpContext.Current.Session["UserSession"];
