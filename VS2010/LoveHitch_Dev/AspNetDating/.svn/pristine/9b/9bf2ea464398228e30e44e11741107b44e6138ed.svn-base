            ...
            finally
            {
                ...
                if (context.Session != null && CurrentSessionUserID > 0)
                {
                    if (dic != null)
                    {
                        ...
                        //       dic["AspNetDating.Classes.AddNewFacebookFriendsBackgroundWorker"];
                ...
                //                        dic["AspNetDating.Classes.LoadAndSaveFacebookImageBackgroundWorker"];
        ...
        public class FacebookFriendDataClass : LoveHitchParallel.WorkThreadClass
        {
            ...
            public override void DoWorkThread(object parameter)
            {
                ...
                try
                {
                    ...
                    //{
                    //    SqlHelper.ExecuteNonQuery(conn, "UpdateFacebookMutualFriends", user.Username, friend.Username, SerializeToXml(frData.MutualFriendsList));
                    //}
                    //time[2] = DateTime.Now;
                    //time[2] = DateTime.Now;
                }
