...
<%--</ContentTemplate>
        ...
        <asp:UpdatePanel ID="upCatalog" runat="server">
                                            ...
                                            <td valign="top">
                                                ...
                                                <div class="buttons">
                                                    <asp:Button ID="btnAdd" CommandName="Add" Text='<%# "Add".Translate() %>' CommandArgument='<%# Eval("ControlPath") %>'
                                                        runat="server" CssClass="medium zurbtn blue fr" />
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
         ...
         <asp:UpdatePanel ID="upRightCatalogButton" runat="server">
            ...
            <ContentTemplate>
                <div class="mode">
                    <asp:LinkButton ID="lnkCatalogForRightParts" runat="server" CssClass="medium blue zurbtn fr"
