...
jQuery(function () {
   var $ = jQuery;
	$.fn.retarder = function(delay, method){
     ...
     $('#fmt').addClass('js-active');
    
     $('#fmt ul li').hover(
        function() { $(this).addClass('selected'); $(this).find('ul.fmtDrpDwn:first').slideDown(400); },
        function() { $(this).removeClass('selected'); $(this).find('ul.fmtDrpDwn:first').fadeOut(200); }
     );
   
    
    
    $('ul div', '#fmt').css('visibility', 'hidden');
    $('ul li', '#fmt').hover(function () {
...
//    setTimeout(function () {
//        $('#fmt ul.fmt').lavaLampV({
//            speed: 400
//        })
//    }, 100);
    if (!($.browser.msie && $.browser.version.substr(0, 1) == '6')) {
        $('#fmt>ul>li>a>span').css('color', 'rgb(61,78,41)');
        $('#fmt>ul>li>a').hover(function () {
        ...
        $('#fmt li li a span').css('color', 'rgb(61,78,41)');
        $('#fmt li li a').hover(function () {
