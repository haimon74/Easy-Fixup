<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveSalutePhotos.aspx.cs" Inherits="AspNetDating.Admin.ApproveSalutePhotos" %>
	                    ...
	                    <tr>
	                        <td>
	                            <asp:UpdatePanel ID="UpdatePanelPhoto" runat="server">
	                                <ContentTemplate>
	                                    <asp:DataList CssClass="approvephoto2-wrap" ID="listPendingApproval" runat="server" OnItemCommand="listPendingApproval_ItemCommand"
