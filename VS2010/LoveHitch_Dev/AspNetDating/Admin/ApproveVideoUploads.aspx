<%@ Page Language="c#" CodeBehind="ApproveVideoUploads.aspx.cs" AutoEventWireup="True"
    Inherits="AspNetDating.Admin.ApproveVideoUploads" %>
        ...
        <div id="main">
            <div id="content-head">
                ...
                <div class="ch-description">
                    <%= Lang.TransA("Use this section to approve or reject pending video uploads...") %>
                </div>
            </div>
                        ...
                        <tr>
                            <td align="right">
                                <asp:Panel ID="pnlVideosPerPage" runat="server" CssClass="perpage">
                                    <%= Lang.TransA("Video uploads per page") %>
                                    :
                                    <asp:DropDownList ID="dropVideosPerPage" CssClass="pages" Font-Name="Verdana" Font-Size="9px"
