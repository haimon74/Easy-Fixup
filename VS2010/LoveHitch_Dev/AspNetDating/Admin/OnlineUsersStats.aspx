<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineUsersStats.aspx.cs" Inherits="AspNetDating.Admin.OnlineUsersStats" %>
...
<html>
	<head>
	    <title><%= Lang.TransA("Online Users Stats") %></title>
	    ...
	    <form id="form1" runat="server">
			...
			<div id="layout">
            	<div id="crupms">
                	...
                	<div id="crumpstxt"><%= Lang.TransA("Online Users Stats")%></div>
                </div>
                <div id="sidebar">
                ...
                <div id="main">
        			<div id="content-head">
						<div class="ch-head"><%= Lang.TransA("Online Users Stats")%></div>
                        <div class="ch-description">
                            <%= Lang.TransA("Use this section to view online users statistics of your site...") %>
                        </div>
                    </div>
                    <table id="tblHideSearch" cellpadding="0" cellspacing="0" class="filter" runat="server" visible="false">
                    	<tr>
                            ...
                            <asp:DataGrid ID="dgOnlineUsers" runat="server" Width="100%" CssClass="btable1" AllowPaging="False"
