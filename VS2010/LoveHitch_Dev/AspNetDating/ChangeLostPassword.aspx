...
<asp:Content id="Content1" ContentPlaceHolderID="cphContent" runat="server">
	<uc1:WideBoxStart id="WideBoxStart1" runat="server"></uc1:WideBoxStart>
		...
		<div class="center">
			<%= AspNetDating.Classes.Lang.Trans("New password") %><br /><br />
			<%= AspNetDating.Classes.Lang.Trans("Please enter a new password:") %><br /><br />
			<input id="txtNewPassword" type="password" runat="server" name="txtNewPassword" /><br /><br />
			<%= AspNetDating.Classes.Lang.Trans("Confirm your new password:") %><br /><br />
