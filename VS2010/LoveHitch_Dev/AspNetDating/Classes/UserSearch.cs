...
namespace AspNetDating.Classes
{
    ...
    public class UserSearchResults : SearchResults<string, User>
    {
        ...
        {
            DataTable dt = User.BulkLoad(ids);
    ...
    public class BasicSearch
    {
        ...
        public User.eGender InterestedIn
        {
            ...
            set
            {
                ...
                // value == User.eGender.Male || value == User.eGender.Female; //|| value == User.eGender.Couple;
            }
        }
        ...
        public IQueryable<Model.User> GetQueryableResult()
        {
            ...
            var db = new AspNetDatingDataContext();
        ...
        public UserSearchResults GetResults()
        {
            ...
            //if (Gender == User.eGender.Male)
            //{
            //    if (InterestedIn == User.eGender.Male)
            //    {
                ...
                case "MutualFriendsCount":
                    ...
                    if (ViewerUsername.IsNotNullOrEmpty())
                    {
                        ...
                        for (int i = 0; i < resUsernames.Count; i++)
                        {
                            ...
                            bool success = User.FindFriendsConnection(ViewerUsername, viewed, 2, out usersChain);
    ...
    public class FacebookMutualFriendsSearch
    {
        ...
        public UserSearchResults GetResults()
        {
            ...
            User viewerUser = User.Load(Viewer);
            User viewedUser = User.Load(Viewed);
    ...
    */
    ...
    public class MutualFriendsSearch
    {
        ...
        public UserSearchResults GetResults()
        {
            var mmyFriends = User.FetchMutualMutuallyFriends(viewer, viewed);
    ...
    public class QuickSingleFriendsSearch
    {
        ...
        public User.eGenderSearch FriendGender { get; set; }
        public User.eGender FriendInterestedIn { get; set; }
        ...
        public QuickSingleFriendsSearch
            ()
        {
            FriendGender = User.eGenderSearch.All;
            FriendInterestedIn = User.eGender.Couple;
            MinAge = Config.Users.MinAge;
            MaxAge = Config.Users.MaxAge;
        ...
        //public UserSearchResults GetResults(User.eGenderSearch gender, User.eGender interestedIn)
        //{
        //    FriendGender = gender;
        ...
        public UserSearchResults GetResults()
        {
            List<string> friends = User.FetchFriends(MatchmakerUsername).ToList();
            ...
            if (FriendGender != User.eGenderSearch.All)
            {
                results.Usernames = (results.Get()
                        .Where(r => r.Gender == (User.eGender)FriendGender &&
                            //r.InterestedIn != User.eGender.Matchmaker
                                   (r.StatusText != "In a relationship" && r.StatusText != "Married")
                                    )
                        .Select(r => r.Username)).ToArray();
            }
            if (FriendInterestedIn != User.eGender.Couple)
            {
                results.Usernames = (results.Get()
