...
namespace AspNetDating.Classes
{
    public class WinkType
    {
        ...
        private static WinkType[] Fetch(int? id, int? categoryId, string name, bool? active, eSortColumn sortColumn)
        {
            ...
            {
                SqlDataReader reader = SqlHelper.ExecuteReader(conn, "FetchWinkTypes",
                                                               id,
                                                               categoryId,
                                                               name,
                                                               active,
        ...
        public void Save()
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                object result = SqlHelper.ExecuteScalar(conn, "SaveWinkType",
                                                        id,
                                                        categoryId,
                                                        name,
                                                        phrase,
        ...
        public static void Delete(int id)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.ExecuteNonQuery(conn, "DeleteWinkType", id);
            }
        }
