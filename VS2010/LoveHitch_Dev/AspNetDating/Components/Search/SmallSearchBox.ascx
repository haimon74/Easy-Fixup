...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SmallSearchBox.ascx.cs" Inherits="AspNetDating.Components.Search.SmallSearchBox" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
