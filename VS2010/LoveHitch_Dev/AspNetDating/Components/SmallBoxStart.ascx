<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SmallBoxStart.ascx.cs" Inherits="AspNetDating.Components.SmallBoxStart" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
