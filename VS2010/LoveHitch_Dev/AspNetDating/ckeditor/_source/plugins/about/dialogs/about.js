						...
						html :
							...
							'<div class="cke_about_container">' +
								...
								'<p>' +
									...
									'<a href="https://ckeditor.com/">https://ckeditor.com</a>' +
								'</p>' +
								'<p>' +
									lang.moreInfo + '<br>' +
									'<a href="https://ckeditor.com/license">https://ckeditor.com/license</a>' +
								'</p>' +
								'<p>' +
									lang.copy.replace( '$1', '<a href="https://cksource.com/">CKSource</a> - Frederico Knabben' ) +
								'</p>' +
							'</div>'
					}
				]
