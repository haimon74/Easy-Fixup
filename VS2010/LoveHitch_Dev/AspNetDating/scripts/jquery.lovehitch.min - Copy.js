...
function UpdateOnline() { if (updateOnlineLock == true) return; updateOnlineLock = true; AspNetDating.Services.OnlineCheck.UpdateOnline(OnUpdateOnlineSucceeded, OnUpdateOnlineError); }
...
function showUserPreview(username) { if (typeof AspNetDating == 'undefined' || userPreviewLoading) return; userPreviewLoading = true; AspNetDating.Services.OnlineCheck.LoadUserPreviewInfo(username, OnLoadUserPreviewInfoSucceeded, OnLoadUserPreviewInfoError); }
