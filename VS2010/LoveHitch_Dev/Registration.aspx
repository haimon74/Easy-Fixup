<%@ Page Language="c#" MasterPageFile="Site.Master" CodeBehind="Registration.aspx.cs"
    AutoEventWireup="True" Inherits="AspNetDating.Registration" %>
            ...
            <div id="registration_lt" class="registration_lt">
                <table class="regtable" cellpadding="5" cellspacing="2">
                        ...
                        <td style="vertical-align: bottom">
                            ...
                            <div style="margin-top: 67px;">
                                ...
                                <button id="btnBrowseTrigger" onclick="javascript:triggerAsyncImgUpload();return false;"
                                    class="medium zurbtn blue" style="padding:3px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="buttons">
                                <uc1:FlexButton ID="btnRegister" name="regButton" runat="server" CssClass="LargeButton"
