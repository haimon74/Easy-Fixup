...
namespace ezFixUp.Classes
{
    public class AffiliateBanner
    {
        ...
        private static AffiliateBanner[] Fetch(int? id, string name, bool? deleted)
        {
            ...
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchAffiliateBanners", id, name, deleted);
        ...
        public void Save()
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveAffiliateBanner",
        ...
        public static void Delete(int id)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteAffiliateBanner", id);
            }
        }
        ...
        public void LoadImage()
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) 
                    SqlHelper.GetDB().ExecuteReader( "FetchAffiliateBannerImage", ID);
