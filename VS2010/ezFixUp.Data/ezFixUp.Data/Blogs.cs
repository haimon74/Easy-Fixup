...
namespace ezFixUp.Classes
{
    ...
    public class BlogPost
    {
                                    ...
                                    string keyword, bool searchInContent, int? numberOfBlogPosts, eSortColumn sortColumn)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "SearchBlogPosts",
    ...
    public class BlogPostComment
    {
                                              ...
                                              bool approved)
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                ...
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchBlogPostComments", id, blogPostId, username,
