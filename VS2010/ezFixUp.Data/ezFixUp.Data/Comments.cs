...
namespace ezFixUp.Classes
{
    ...
    public class Comment
    {
                                     ...
                                     bool approved, int countLimit)
        {
            ...
            //using (SqlConnection conn = Config.DB.Open())
            //{
            //    SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchComments", id, fromUsername,
        ...
        public static int FetchNewComments(string username)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                return Convert.ToInt32(SqlHelper.GetDB().ExecuteScalar( "FetchNewCommentsCount", username));
            }
        }
        ...
        public static void Delete(int id)
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteComment", id);
            }
        }
    }
}