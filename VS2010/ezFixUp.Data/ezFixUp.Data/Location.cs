...
//		}
    ...
    /// <summary>
    /// The Distance class takes two <see cref="ezFixUp.Data.Location" /> objects and
    ...
    public class Radius
    {
        ...
        /// <summary>
        /// Finds all <see cref="ezFixUp.Data.LocationInRadius" />es within X miles
        ///  of inRefLoc.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>0 or more <see cref="ezFixUp.Data.LocationInRadius" />es that are
...
//			oleCmd.Parameters.Add (new OleDbParameter ("EastLong", inBounds.RightLine));
        ...
        /// <summary>
        /// Allows for sorting of an ArrayList of <see cref="ezFixUp.Data.LocationInRadius" /> 
