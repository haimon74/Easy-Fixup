...
namespace ezFixUp.Classes
{
    ...
    public class PhotoContestEntry
    {
                                               ...
                                               string notRankedBy, int? countLimit, bool randomize)
        {
            ...
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "LoadPhotoContestEntry", id, contestId,
        ...
        public static int[] FetchTop(int contestId, int? maxCount)
        {
            ...
            if (updateRanks)
            {
                ...
                using (SqlConnection conn = Config.DB.Open())
                {
                    SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchTopEntries", contestId,
