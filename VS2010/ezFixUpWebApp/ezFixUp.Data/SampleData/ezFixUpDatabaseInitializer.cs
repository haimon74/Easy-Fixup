...
namespace ezFixUp.Data.SampleData
{ 
    public class ezFixUpDatabaseInitializer :
        //CreateDatabaseIfNotExists<ezFixUpDbContext>      // when model is stable
        DropCreateDatabaseIfModelChanges<ezFixUpDbContext> // when iterating
    {
        ...
        protected override void Seed(ezFixUpDbContext context)
        {
            // Seed code here
        ...
        private List<Room> AddRooms(ezFixUpDbContext context)
        {
        ...
        private List<TimeSlot> AddTimeSlots(ezFixUpDbContext context)
        {
        ...
        private List<Track> AddTracks(ezFixUpDbContext context)
        {
        ...
        private List<Person> AddPersons(ezFixUpDbContext context, int count)
        {
        ...
        private void AddAttendance(ezFixUpDbContext context, IEnumerable<Person> attendees)
        {
