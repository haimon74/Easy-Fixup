<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationWizard.aspx.cs" Inherits="ezFixUp.Admin.ConfigurationWizard" %>
        ...
        <%--                <SideBarStyle VerticalAlign="Top"  />
                        ...
                        <WizardSteps>
                            <asp:WizardStep ID="wsSiteDetails" runat="server" Title="Site Details">        
                                ...
                                <tr>
	                                <td class="table_cell" colspan="2"><b><%= "Site languages".TranslateA() %></b> - <%= "ezFixUp comes with several language packs which you can use right away. If you need to use another language you can enter it in the textbox below. Additional languages can be added from the \"Edit Languages\" page.".TranslateA()%> <asp:CheckBoxList ID="cblSiteLanguages" runat="server"></asp:CheckBoxList>
