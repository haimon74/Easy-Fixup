    ...
    public partial class EditPopupTips : AdminPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["preview"] == "1" && !string.IsNullOrEmpty(Request.QueryString["fileId"]))
            {
                ...
                var fileContents = (byte[])Global.GetSessionState()["fileContents_" + fileId];
                var fileContentType = (string)Global.GetSessionState()["fileContentType_" + fileId];
        ...
        protected void ajaxUpload1_OnUploadComplete(object sender, AjaxFileUploadEventArgs e)
        {
            ...
            {
                Global.GetSessionState()["fileContentType_" + e.FileId] = e.ContentType;
                Global.GetSessionState()["fileContents_" + e.FileId] = e.GetContents();
            }
