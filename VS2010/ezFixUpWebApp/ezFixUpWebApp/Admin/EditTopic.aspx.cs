...
namespace ezFixUp.Admin
{
    ...
    {
        //protected System.Web.UI.WebControls.DropDownList dropColumns;
        protected MessageBox MessageBox;
        //protected System.Web.UI.WebControls.Label lblMessage;
        //protected System.Web.UI.WebControls.Label lblColumns;
        ...
        {
            btnAddNewQuestion.Text = Lang.TransA("Add new question");
            ...
            btnDeleteSelectedQuestions.Text = Lang.TransA("Delete selected questions");
        ...
        {
            this.dgQuestions.ItemCreated +=
                new System.Web.UI.WebControls.DataGridItemEventHandler(this.dgQuestions_ItemCreated);
            this.dgQuestions.ItemCommand +=
                new System.Web.UI.WebControls.DataGridCommandEventHandler(this.dgQuestions_ItemCommand);
            this.dgQuestions.ItemDataBound +=
                new System.Web.UI.WebControls.DataGridItemEventHandler(this.dgQuestions_ItemDataBound);
        }
        ...
        private void dgQuestions_ItemCreated(object sender, DataGridItemEventArgs e)
        {
        ...
        private void dgQuestions_ItemCommand(object source, DataGridCommandEventArgs e)
        {
        ...
        {
            ProfileTopic topic = null;
            if (Global.GetSessionState().ContainsKey("TempTopic")) 
                topic = Global.GetSessionState()["TempTopic"] as ProfileTopic;
        ...
        {
            Global.GetSessionState()["TempTopic"] = null;
        }
        ...
        private void dgQuestions_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemIndex == -1)
                return;
