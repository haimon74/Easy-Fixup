...
namespace ezFixUp.Classes {
	...
	public class FAQ {
        ...
        public void Save()
        {
            ...
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveFAQ",
        ...
        public void SaveOrder()
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveOrderFAQ", (object) id,order);
            }
		...
		public static void Delete(int id)
		{
			...
			using(SqlConnection conn = Config.DB.Open()) {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteFAQ", id);
			}
        ...
        public static FAQ[] FetchAll(int categoryId)
        {
			...
			using(SqlConnection conn = Config.DB.Open()) {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchFAQs", categoryId);
        ...
        private static FAQ[] Fetch(int id, string name)
        {
			...
			using(SqlConnection conn = Config.DB.Open()) {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchFAQ", id, name);
        ...
        public static DataTable FetchCategories()
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchFaqCategories", null, null,1);
