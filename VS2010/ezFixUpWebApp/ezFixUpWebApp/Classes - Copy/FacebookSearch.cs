...
namespace ezFixUp.Classes
{
    ...
    public class FacebookFriendsSearch
    {
        public FacebookSearchResults GetResults()
        {
            ...
            LoveHitchFacebookApp facebook = FacebookHelper.GetSessionFacebookApp(userSession.FacebookID.HasValue);
    ...
    public class FacebookMutualFriendsSearch
    {
        ...
        private LoveHitchFacebookApp fbAppSession;
        ...
        public FacebookMutualFriendsSearch(string viewer, string viewed, UserSession userSession, LoveHitchFacebookApp facebookApp)
        {
            this.Viewed = viewed;
            this.Viewer = viewer;
        ...
        #endregion
        public List<SearchMutualFriendsClass> GetSavedResults()
        {
            ...
            {
                return HttpContext.Current.Cache[cacheKey] as List<SearchMutualFriendsClass>;
            }

            var lstMutualFriends = new List<SearchMutualFriendsClass>();
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                try
                {
                    XmlReader reader = (XmlReader)
                        SqlHelper.GetDB().ExecuteReader("FetchFacebookMutualFriends", Viewer, Viewed);
                    StringWriter writer = new StringWriter(CultureInfo.InvariantCulture);
                    XmlSerializer serializer = new XmlSerializer(new List<SearchMutualFriendsClass>().GetType());
                    lstMutualFriends = (List<SearchMutualFriendsClass>)serializer.Deserialize(reader);
                }
                catch (Exception ex)
                {
                }
