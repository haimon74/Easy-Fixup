...
namespace ezFixUp.Classes
{
    public class GroupPhoto
    {
                                            ...
                                            string name, DateTime? date, int? numberOfPhotos, eSortColumn sortColumn)
        {
            ...
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchGroupPhotos",
        ...
        public static int[] Search(int? groupID, string username, string name, DateTime? date, string keyword, eSortColumn sortColumn)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "SearchGroupPhotos",
        ...
        public static Image LoadImage(int groupPhotoID)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) 
                    SqlHelper.GetDB().ExecuteReader( "FetchGroupPhoto", groupPhotoID);
