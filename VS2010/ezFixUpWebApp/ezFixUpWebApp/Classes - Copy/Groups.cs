...
namespace ezFixUp.Classes
{
    ...
    public class Group
    {
                                    ...
                                    int? activeMembers, bool? autojoin, int? numberOfGroups, eSortColumn sortColumn)
        {
            ...
            //{
            //    SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchGroups", id, name, description, dateCreated,
                                    ...
                                    string keyword, bool searchInDescription, int? numberOfGroups, eSortColumn sortColumn)
        {
            ...
            //using (SqlConnection conn = Config.DB.Open())
            //{
            //    SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "SearchGroups",
        ...
        public static int FetchPendingInvitations(string username)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                return Convert.ToInt32(SqlHelper.GetDB().ExecuteScalar( "FetchGroupsPendingInvitations", username));
            }
        }
        ...
        private static Group[] FetchGroupsBy(int? categoryID, string username, bool? approved)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                ...
                if (categoryID != null)
                {
                    reader = (SqlDataReader)SqlHelper.GetDB().ExecuteReader("FetchGroupsByCategory", categoryID, approved);
                }
                else
                {
                    reader = (SqlDataReader)SqlHelper.GetDB().ExecuteReader("FetchGroupsByUsername", username, approved);
                }
        ...
        private static int[] SearchGroupsByUsername(string username, bool? approved, eSortColumn eSortColumn)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "SearchGroupsByUsername", username, approved, eSortColumn);
        ...
        private static int FetchGroupsByCategoryCount(int categoryID, bool? approved)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                return Convert.ToInt32(SqlHelper.GetDB().ExecuteScalar( "FetchGroupsByCategoryCount", categoryID, approved));
            }
        }
        ...
        public void Save()
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveGroup",
        ...
        public static void Delete(int id)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteGroup", (int?) 3600, new [] {new SqlParameter("@ID", id)});
            }
        ...
        public static void DeleteInactiveGroups(int daysOfInactivity)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteInactiveGroups", DateTime.Now - TimeSpan.FromDays(daysOfInactivity));
            }
        }
        ...
        public void MoveGroupToCategory(int groupID, int oldCategoryID, int newCategoryID)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "MoveGroupToCategory",
        ...
        public void AssignGroupToCategory(int groupID, int categoryID)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "AssignRemoveGroupToFromCategory",
        ...
        public void SetCategories(int[] categoriesIDs)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteGroupFromCategories", id);

                foreach (int categoryID in categoriesIDs)
                {
                    SqlHelper.GetDB().ExecuteNonQuery( "AssignRemoveGroupToFromCategory", id, categoryID, eAction.Assign);
                }
            }
        }
        ...
        public static bool IsNameUsed(string groupName)
        {
            ...
            {
                return
                    (bool)SqlHelper.GetDB().ExecuteScalar( "IsGroupNameUsed", groupName);
            }
        }
        ...
        public static Image LoadIcon(int groupID)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader)
                    SqlHelper.GetDB().ExecuteReader( "FetchGroupIcon", groupID);
    ...
    public class GroupSearchResults : SearchResults<int, Group>
    {
        ...
        protected override Group[] LoadResults(int[] ids)
        {
