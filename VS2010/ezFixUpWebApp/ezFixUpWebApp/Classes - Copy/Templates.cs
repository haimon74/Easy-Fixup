...
namespace ezFixUp.Classes
{
    ...
    public class EmailTemplates 
    {
        ...
        public class NewPasswordConfirmation : IEmailTemplate
        {
            ...
            [Reflection.PropertyAttribute("CssClass", "tsingleline")]
        ...
        public interface IEmailInviteFriendTemplate : IEmailTemplate
        {
            string GetFormattedBody(string senderName);
            string GetFormattedSubject(string senderName);
        }


        //[Reflection.DescriptionAttribute("Invite a friend template")]
        //public class InviteFriend : IEmailInviteFriendTemplate
        //{
        //    public InviteFriend()
        //    {
        //    }
        ...
        //    protected const string DefaultSubject = "Invitation from %%SENDER%%";

        //    protected string DefaultBody = "Hi,<br>\r\n"
        //                                 + "<br>\r\n"
        ...
        [Reflection.DescriptionAttribute("Invite a friend by matchmaker template")]
        public class InviteFriendByMatchmaker : IEmailInviteFriendTemplate
        {
            public InviteFriendByMatchmaker()
            {
            }

            public InviteFriendByMatchmaker(int languageId)
            {
                this.languageId = languageId;
            }
            ...
            public string Subject
            {
                get { return DBSettings.Get("InviteFriendByMatchmaker_Subject_" + LanguageId.ToString(), DefaultSubject); }
                set { DBSettings.Set("InviteFriendByMatchmaker_Subject_" + LanguageId.ToString(), value); }
            }
            ...
            public string Body
            {
                get { return DBSettings.Get("InviteFriendByMatchmaker_Body_" + LanguageId.ToString(), DefaultBody); }
                set { DBSettings.Set("InviteFriendByMatchmaker_Body_" + LanguageId.ToString(), value); }
            }
        ...
        [Reflection.DescriptionAttribute("Invite a friend by male template")]
        public class InviteFriendByMale : IEmailInviteFriendTemplate
        {
            public InviteFriendByMale()
            {
            }

            public InviteFriendByMale(int languageId)
            {
                this.languageId = languageId;
            }

            private int languageId = Config.Misc.DefaultLanguageId;
            ...
            public string Subject
            {
                get { return DBSettings.Get("InviteFriendByMale_Subject_" + LanguageId.ToString(), DefaultSubject); }
                set { DBSettings.Set("InviteFriendByMale_Subject_" + LanguageId.ToString(), value); }
            }
            ...
            public string Body
            {
                get { return DBSettings.Get("InviteFriendByMale_Body_" + LanguageId.ToString(), DefaultBody); }
                set { DBSettings.Set("InviteFriendByMale_Body_" + LanguageId.ToString(), value); }
            }
        ...
        [Reflection.DescriptionAttribute("Invite a friend by female template")]
        public class InviteFriendByFemale : IEmailInviteFriendTemplate
        {
            public InviteFriendByFemale()
            {
            }

            public InviteFriendByFemale(int languageId)
            {
                this.languageId = languageId;
            }
            ...
            public string Subject
            {
                get { return DBSettings.Get("InviteFriendByFemale_Subject_" + LanguageId.ToString(), DefaultSubject); }
                set { DBSettings.Set("InviteFriendByFemale_Subject_" + LanguageId.ToString(), value); }
            }
            ...
            public string Body
            {
                get { return DBSettings.Get("InviteFriendByFemale_Body_" + LanguageId.ToString(), DefaultBody); }
                set { DBSettings.Set("InviteFriendByFemale_Body_" + LanguageId.ToString(), value); }
            }
        ...
        //[Reflection.DescriptionAttribute("New message received notification template")]
        //public class NewMessageReceived : EmailTemplateBase
        //{
        //    public NewMessageReceived() 
        //    {
        //    }
        //    public NewMessageReceived(int languageId) : base(languageId)
        //    {
        //    }

        //    protected string DefaultSubject = Config.Misc.SiteTitle + " message received from %%SENDER%%";

        //    protected string DefaultBody = "Hi,<br>\r\n"
        //                                 + "<br>\r\n"
        //                                 + "You've received a message from %%SENDER%%"
        //                                 + "<a href=\"" + Config.Urls.Home + "MailBox.aspx\">" + Config.Misc.SiteTitle +
        //                                 "</a> <br>\r\n"
        //                                 + "Regards,<br>\r\n"
        //                                 + Config.Misc.SiteTitle;
        //}

        [Reflection.DescriptionAttribute("Bonus for invited by new users registered")]
        public class InvitedByUserBonus : EmailTemplateBase
        {
            public InvitedByUserBonus()
            {
            }
            public InvitedByUserBonus(int languageId)
                : base(languageId)
            {
            }

            protected string DefaultSubject = "You received a bonus from " + Config.Misc.SiteTitle;

            protected string DefaultBody = "Hi,<br>\r\n"
                                         + "<br>\r\n"
                                         + "You've received a bonus from " + Config.Misc.SiteTitle
                                         + "Due to registered users by your invitations " + Config.Misc.SiteTitle
                                         + "<a href=\"" + Config.Urls.Home + "InviteFriends.aspx\">" + Config.Misc.SiteTitle +
                                         "</a> <br>\r\n"
                                         + "Regards,<br>\r\n"
                                         + Config.Misc.SiteTitle;
        }

        [Reflection.DescriptionAttribute("Base email template")]
        public class EmailTemplateBase : IEmailTemplate
        {
            public EmailTemplateBase()
            {
            }

            public EmailTemplateBase(int languageId)
            {
                this.languageId = languageId;
            }
            ...
            protected string DefaultSubject = "Base message from %%SENDER%%";

            protected string DefaultBody = "Hi,<br>\r\n"
                                         + "<br>\r\n"
                                         + "Base Message "
                                         + "<a href=\"" + Config.Urls.Home + "default.aspx\">" + Config.Misc.SiteTitle +
                                         "</a> <br>\r\n"
                                         + "Regards,<br>\r\n"
                                         + "%%SENDER%%";
            ...
            public string Subject
            {
                get { return DBSettings.Get(this.GetType().Name + "_Subject_" + LanguageId.ToString(), DefaultSubject); }
                set { DBSettings.Set(this.GetType().Name + "_Subject_" + LanguageId.ToString(), value); }
            }
            ...
            public string Body
            {
                get { return DBSettings.Get(this.GetType().Name + "_Body_" + LanguageId.ToString(), DefaultBody); }
                set { DBSettings.Set(this.GetType().Name + "_Body_" + LanguageId.ToString(), value); }
            }
            ...
            public string GetFormattedBody(string senderUsername, string recipientName, string message, string sentUsername)
            {
                ...
                if (sentUser != null && !sentUser.Deleted)
                {
                    ...
                    try
                    {
                        ...
                        body = body.Replace("%%PHOTOURL%%", ImageHelper.CreateImageUrl(primaryPhoto.Id, 450, 450, false, true, false));
                        body = body.Replace("%%PHOTOID%%", primaryPhoto.Id.ToString());
                    }
                    catch (NotFoundException)
                    {
                        body = body.Replace("%%PHOTOURL%%", ImageHelper.CreateImageUrl(ImageHelper.GetPhotoIdByGender(sentUser.Gender), 90, 90, false, true, false));
                        body = body.Replace("%%PHOTOID%%", "0");
                    }

                    body =
                        body.Replace("%%PROFILEURL%%",
                                     Config.Urls.Home.TrimEnd('/') + "/ShowUser.aspx?uid=" + sentUser.Username);
                }
        ...
        public class SavedSearchMatches : IEmailTemplate
        {
            ...
            private string generateItemTemplate(string username, string itemTemplate)
            {
                ...
                try
                {
                    ...
                    itemTemplate = itemTemplate.Replace("%%PHOTOURL%%", ImageHelper.CreateImageUrl(primaryPhoto.Id, 90, 90, false, true, true));
                }
                catch (NotFoundException)
                {
                    itemTemplate = itemTemplate.Replace("%%PHOTOURL%%", ImageHelper.CreateImageUrl(ImageHelper.GetPhotoIdByGender(matchedUser.Gender), 90, 90, false, true, false));
                }

                itemTemplate =
                    itemTemplate.Replace("%%PROFILEURL%%",
                                 Config.Urls.Home.TrimEnd('/') + "/ShowUser.aspx?uid=" + matchedUser.Username);
    ...
    public static class TemplateGenerator
    {
        ...
        /// <param name="senderUsername">The sender username.</param>
        /// <returns></returns>
        public static string GetKeyValueFormattedString(this string org, string key, string value)
        {
            return org = org.Replace(key, value);
        }
        public static string GetFormattedString(this string templateStr, User user)
        {
            return templateStr.GetKeyValueFormattedString("%%RECIPIENT%%", user.Name)
                              ...
                              .GetKeyValueFormattedString("%%PHOTOURL%%",ImageHelper.CreateImageUrl(user.GetPrimaryPhoto().Id,200,200,false,false,true)
                              ...
                              .GetKeyValueFormattedString("%%SITETITLE%%","LoveHitch")
