...
using System.Web;
using System.Xml;
using Config = ezFixUp.Data.Config;
...
namespace ezFixUp.Classes
{
    public class UrlRewrite : IConfigurationSectionHandler
    {
        ...
        public string GetSubstitution(string zPath)
        {
            ...
            var pages = Data.ContentPage.FetchContentPages(null, null, Data.ContentPage.eSortColumn.None).ToList();
            foreach (Data.ContentPage page in pages)
            {
        ...
        public static string CreateContentPageUrl(int id, bool rewriteUrl)
        {
            ...
            if (rewriteUrl)
            {
                Data.ContentPage page = Data.ContentPage.FetchContentPage(id);
