...
namespace ezFixUp.Classes
{
    public class Config
    {
        ...
        public class ServerSettings
        {
            ...
            {
                get { return DBSettings.Get("ServerSettings_DomainURL", "https://ezFixUp.com"); }
        ...
        public class DB
        {
            ...
            public static string ConnectionString
            {
                get
                {
                    ...
                    {
                        if (ConfigurationManager.ConnectionStrings["ezFixUpDB"] != null)
                        {
                            connectionString = ConfigurationManager.ConnectionStrings["ezFixUpDB"].ConnectionString;
                        }
                        else
                        {
            ...
            {
                var conSql = SqlHelper.GetDB().CreateConnection();
        ...
        public class Misc
        {
            ...
            {
                get { return DBSettings.Get("Misc_GadgetsPrefix", "AspNetDating Admin Stats"); }
            ...
            {
                get { return DBSettings.Get("Misc_SiteEmail", "noreply@ezFixUp.com"); }
        ...
        public class Users
        {
            ...
            public static string MapFacebookCityToezFixUpCity(HttpContext context, string fbCity, out string region, out string country)
            {
                region = null;
                country = null;
            ...
            public static string[] GetUsersWithinRadius(Location inLocation, bool? hasAnswer, Classes.User.eGender gender,
                                                        int maxAge,
                                                        ...
                                                        int maxResults)
            {
                ...
                //using (var conn = DB.Open())
                {
                    ...
                    using (var reader = SqlHelper.GetDB().ExecuteReader("FetchUsersInRadius",
                                                                        hasAnswer, (int) gender,
                                                                        DateTime.Now.Subtract(
                                                                            TimeSpan.FromDays(maxAge*365.25)),
                                                                        DateTime.Now.Subtract(
                                                                            TimeSpan.FromDays(minAge*365.25)),
                                                                        photoReq,
                                                                        radBox.BottomLine,
                                                                        radBox.TopLine,
                                                                        radBox.LeftLine,
