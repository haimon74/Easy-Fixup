...
namespace ezFixUp.Classes
{
    public class FacebookFriendsDataBackgroundWorkerClass
    {
        ...
        private ezFixUpFacebookApp _facebook;
        private long _id;
        private string _accessToken;

        public FacebookFriendsDataBackgroundWorkerClass(PageBase pageBase, HttpContext context,
                                                   ezFixUpFacebookApp facebook, long id, string accessToken)
        {
            _pageBase = pageBase;
            _context = context;
        ...
        public void UpdateFriendsData()
        {
            ...
            #region obsolete 1
            //int totalFriendsCount = friendsCount;
            //int limit = 40;
            ...
            //    loadOnlyWithMutualFriends = !User.IsUsernameTaken(lstFacebookSessionMutualFriends.Last().FriendID.ToString());
            //}
            ...
            var dic2 = (Dictionary<string, ezFixUpBackgroundWorker>)Global.AppBackgroundWorkersDic;
                ...
                if (dic2 != null)
                {
                    ...
                    var bgWorker1 =
                        (AddNewFacebookFriendsBackgroundWorker)
                           dic2["ezFixUp.AddNewFacebookFriendsBackgroundWorker"];
