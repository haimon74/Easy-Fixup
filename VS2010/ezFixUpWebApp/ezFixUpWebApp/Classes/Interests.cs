...
//            {
//                status = (eStatus) SqlHelper.GetDB().ExecuteScalar(
...
//                    try
//                    {
//                         targetUser = Classes.User.Load(toUsername);
//                     }
...
//        }
        ...
        public static Interest[] Fetch(int id, string fromUsername, string toUsername, bool newInterests)
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchInterests",
                                                                    id, fromUsername, toUsername, newInterests))
                {
