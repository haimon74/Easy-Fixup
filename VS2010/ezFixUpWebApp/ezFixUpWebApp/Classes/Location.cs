...
//		}
    ...
    /// <summary>
    /// The Distance class takes two <see cref="ezFixUp.Classes.Location" /> objects and
    ...
    public class Distance
    {
        ...
        private static double Haversine(Location inLoc1, Location inLoc2, char units)
        {
            /*
				...
				https://mathforum.org/library/drmath/view/51879.html
    ...
    public class Radius
    {
        ...
        /// <returns></returns>
        public static LocationInRadius[] UserLocationsWithinRadius(Location inLocation, Classes.User.eGender gender, int maxAge,
        ...
        /// <summary>
        /// Finds all <see cref="ezFixUp.Classes.LocationInRadius" />es within X miles
        ///  of inRefLoc.
        /// </summary>
        /// <remarks>
        ...
        /// <returns>0 or more <see cref="ezFixUp.Classes.LocationInRadius" />es that are
        ///  within Radius miles of inRefLoc.</returns>
        public static LocationInRadius[] GetUserLocationsWithinRadius(Location inRefLoc, Classes.User.eGender gender, int maxAge,
...
//			oleCmd.Parameters.Add (new OleDbParameter ("EastLong", inBounds.RightLine));
            ...
            {
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchUserLocationsInRadius",
                                                                    (int) gender,
        ...
        /// <summary>
        /// Allows for sorting of an ArrayList of <see cref="ezFixUp.Classes.LocationInRadius" /> 
    ...
    public class RadiusBox
    {
        ...
        /// </summary>
        /// <remarks>
        /// <para>Formula obtained from Dr. Math at https://www.mathforum.org/library/drmath/view/51816.html.</para>
        /// </remarks>
