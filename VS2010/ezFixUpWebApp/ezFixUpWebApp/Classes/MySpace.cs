...
namespace ezFixUp.Classes.MySpace
{
        ...
        public Classes.User.eGender? Gender 
        {
            get
            {
                if (!String.IsNullOrEmpty(GenderString))
                {
                    ...
                    {
                        case "male":
                            return Classes.User.eGender.Male;
                        case "female":
                            return Classes.User.eGender.Female;
                        default:
                            return null;
                    }
                }
    ...
    public static class DataAvailability
    {
        private static readonly OAuthService GetService =
            OAuthService.Create(new Uri("https://api.myspace.com/request_token"),
                new Uri("https://api.myspace.com/authorize"),
                new Uri("https://api.myspace.com/access_token"),
        ...
        public static UserData GetUserData(HttpContext context, Uri callback) 
        {
            ...
            IToken reqToken = null, accessToken = null;

            if (Global.GetSessionState().ContainsKey("MySpace_request_token"))
                reqToken = Global.GetSessionState()["MySpace_request_token"] as IToken;
            
            if (Global.GetSessionState().ContainsKey("MySpace_access_token"))
                accessToken = Global.GetSessionState()["MySpace_access_token"] as IToken;

            var request = OAuthRequest.Create(new Uri("https://api.myspace.com/v2/people/@me/@self"),
                DataAvailability.GetService, reqToken,accessToken);
            ...
            { 
                ...
                Global.GetSessionState()["MySpace_access_token"] = response.Token;
            ...
            {
                Global.GetSessionState()["MySpace_request_token"] = response.Token;  
        ...
        public static string[] GetFriends(HttpContext context, Uri callback)
        {
            ...
            var request = OAuthRequest.Create(new Uri("https://api.myspace.com/v2/people/@me/@friends"),
                                              DataAvailability.GetService, reqToken, accessToken);
        ...
        {
            Global.GetSessionState()["MySpace_request_token"] = null;
            Global.GetSessionState()["MySpace_access_token"] = null;
        }
    }
}
