    ...
    public class ProfileAnswer
    {
        ...
        public static ProfileAnswer Fetch(string Username, int QuestionID)
        {
            ...
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchProfileAnswer",
                                                                    Username, QuestionID))
                {
        ...
        public static ProfileAnswer[] FetchByQuestionID(int QuestionID)
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchProfileAnswerByQuestion", QuestionID))
                {
        ...
        public static ProfileAnswer[] FetchByUsername(string Username)
        {
            ...
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchProfileAnswerByUser", Username))
                {
        ...
        public static ProfileAnswer[] FetchNonApproved()
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchNonApprovedAnswers"))
                {
