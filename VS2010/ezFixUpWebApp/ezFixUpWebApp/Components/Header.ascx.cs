        ...
        */
        ...
        private void PrepareStrings()
        {
            ...
            if (Page is PageBase && CurrentUserSession != null)
            {
                ...
                pnlLoginView.Style["direction"] = Language.Fetch(Convert.ToInt32(Global.GetSessionState()["LanguageId"])).Direction;
        ...
        protected void lnkAjaxChatPay_Click(object sender, EventArgs e)
        {
            if (CurrentUserSession != null)
            {
                Global.GetSessionState()["BillingPlanOption"] = CurrentUserSession.BillingPlanOptions.UserCanUseChat;
