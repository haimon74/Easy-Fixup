...
<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="ViewVideoBroadcast.ascx.cs"
    Inherits="ezFixUp.Components.Profile.ViewVideoBroadcast" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
	...
	<tr>
		...
		<td valign="top">
			<div class="videopanel">
			    ...
			    <div id="videomessages" class="videomessages"></div>
