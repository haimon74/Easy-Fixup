<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SearchSingleChoice.ascx.cs" Inherits="ezFixUp.Components.Search.SearchSingleChoice" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
