<%@ Page Title="" Language="C#" MasterPageFile="~/Mobile/Site.Master" AutoEventWireup="true"
    CodeBehind="Mailbox.aspx.cs" Inherits="ezFixUp.Mobile.Mailbox" %>
            ...
            <tr>
                ...
                <td align="left" valign="top">
                    ...
                    <%# Convert.ToBoolean(Eval("IsRead"))?"":"<img src=\"images/email-unread.gif\" border=\"0\">" %>&nbsp;<a
                        href="ShowMessage.aspx?mid=<%# DataBinder.Eval(Container, "DataItem.Id") %> <%# Global.GetSessionState()[""] %>"><%# DataBinder.Eval(Container, "DataItem.Message") %></a>
                </td>
            </tr>
        </AlternatingItemTemplate>
        <ItemTemplate>
