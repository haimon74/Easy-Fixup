    ...
    public partial class Search : PageBase
    {
        ...
        public UserSearchResults Results
        {
            set
            {
                ...
                Global.GetSessionState()["SearchResults" + ViewState["SearchResults_guid"]] = value;
            ...
            get
            {
                if (ViewState["SearchResults_guid"] != null)
                {
                    return (UserSearchResults)
                           Global.GetSessionState()["SearchResults" + ViewState["SearchResults_guid"]];
                }
                return null;
            }
        }
        ...
        private void LoadCountries()
        {
            ...
            foreach (CascadingDropDownNameValue value in Service.GetCountries(true))
            {
                ListItem item = new ListItem(value.name, value.value);
                item.Selected = value.isDefaultValue;
...
//            if (Global.GetSessionState()["UsernameSearchRequest"] != null)
//            {
//                btnUsernameSearchGo_Click(null, null);
//                return;
//            }

            if (Global.GetSessionState()["NewUsersSearch"] != null)
            {
            ...
            if (Global.GetSessionState()["OnlineUsersSearch"] != null)
            {
            ...
            if (Global.GetSessionState()["ShowProfileViewers"] != null)
            {
            ...
            if (Global.GetSessionState()["MutualVoteSearch"] != null)
            {
