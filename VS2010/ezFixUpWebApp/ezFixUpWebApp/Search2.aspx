<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="Search2.aspx.cs"
    Inherits="ezFixUp.Search2"  Async="true" %>

<%@ MasterType TypeName="ezFixUp.Site" %>
...
<%@ Register TagPrefix="components" Namespace="ezFixUp.Components" Assembly="ezFixUp" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ Register TagPrefix="uc1" Namespace="ezFixUp.Components" %>
