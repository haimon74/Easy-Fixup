...
namespace ezFixUp.Services
{
    ...
    public class Gadgets : WebService
    {
        ...
        //    return Message.Search(0, null, Message.eFolder.None, username, Message.eFolder.None, 
        //        7, false, true, true, false, null, 2).Length;
        //}

        /// <summary>
        /// Gets the new gifts count.
        /// </summary>
        /// <param name="username">The username.</param>
        /// <param name="hash">The hash.</param>
        /// <returns></returns>
        [WebMethod]
        [ScriptMethod(UseHttpGet = true)]
        public int GetNewGiftsCount(string username, string hash)
        {
            string encodedData = Convert.ToBase64String(Encoding.ASCII.GetBytes(username));
            string hash2 = Misc.HMACSHA1ToHex(encodedData, Properties.Settings.Default.SecretGadgetKey);
