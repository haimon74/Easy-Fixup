...
namespace ezFixUp.Services
{
    /// <summary>
    /// General usage web service
    /// </summary>
    [WebService(Namespace = "ezFixUp.Service")]
    ...
    public class Service : WebService
    {
        ...
        public CascadingDropDownNameValue[] GetLanguages(string knownCategoryValues, string category)
        {
            ...
            int defaultLanguageId = Global.GetSessionState().ContainsKey("LanguageId") ? (int)Global.GetSessionState()["LanguageId"] : 1;
        ...
        #region Used by ezFixUp Notifier
        ...
        #region Used by ezFixUp Administration Tool
        ...
        {
            return HttpContext.Current.Session != null ? (int)Global.GetSessionState()["LanguageId"] : 6;            
        }
