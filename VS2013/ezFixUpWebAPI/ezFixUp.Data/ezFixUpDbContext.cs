...
{
    public class ezFixUpDbContext : DbContext 
    {
        // ToDo: Move Initializer to Global.asax; don't want dependence on SampleData
        static ezFixUpDbContext()
        {
            Database.SetInitializer(new ezFixUpDatabaseInitializer());
        }

        public ezFixUpDbContext()
            : base(nameOrConnectionString: "ezFixUp") { }
