<%@ Page language="c#" Codebehind="SpamCheck.aspx.cs" AutoEventWireup="True" Inherits="ezFixUp.Admin.SpamCheck" %>
				    ...
				    <asp:DataGrid id="dgPendingMessages" CssClass="btable1" Runat="server" Width=100% PageSize="2" AllowPaging="True" AutoGenerateColumns="False"
					    ...
					    <Columns>
						    <asp:TemplateColumn>
							    ...
							    <ItemTemplate>
							    <a target="_blank" href="<%= ezFixUp.Classes.Config.Urls.Home%>/ShowUser.aspx?uid=<%# Eval("FromUsername")%>"><%# Eval("FromUsername")%></a>
							    </ItemTemplate>
						    </asp:TemplateColumn>
						    <asp:TemplateColumn>
							    <HeaderStyle CssClass="table_header2"></HeaderStyle>
