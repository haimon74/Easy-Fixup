...
{
    public class ezFixUpBackgroundWorker : BackgroundWorker
    {
        private HttpContext Context;
        
        public ezFixUpBackgroundWorker(HttpContext context)
        {
        ...
        /// </summary>
        public static void StartBackgroundWorker(ezFixUpBackgroundWorker backgroundWorker)
        {
            ...
            //((Dictionary<string, ezFixUpBackgroundWorker>)
        ...
        public static void StopBackgroundWorker(ezFixUpBackgroundWorker backgroundWorker)
        {
            var worker = backgroundWorker;
            if (worker != null)
                worker.CancelAsync();
    ...
    public class LoadAndSaveFacebookImageBackgroundWorker : ezFixUpBackgroundWorker
    {
        //public bool Result;
        public List<ezFixUpFacebookApp> FacebookAppList;
            ...
            base(context)
        {
            ...
            WorkerSupportsCancellation = true;
            FacebookAppList = new List<ezFixUpFacebookApp>();
        }

        //protected override void OnDoWork(DoWorkEventArgs e)
        public new static void DoWork(ezFixUpFacebookApp facebook, HttpContext context)
        {
                        ...
                        if (lstFriendsIds.Count > 0)
                        {
                            try
                            {
                                var parameterizedThreadsList =
                                    new ezFixUpParallel.ParameterizedThreadsList<long>(
                                        lstFriendsIds,
    ...
    public class FetchDbImageToCacheDirectoryBackgroundWorker : ezFixUpBackgroundWorker
    {
        //public bool Result;
    ...
    public class UpdateFacebookFriendsDataBackgroundWorker : ezFixUpBackgroundWorker
    {
        //public bool Result;
    ...
    public class AddNewFacebookFriendsBackgroundWorker : ezFixUpBackgroundWorker
    {
        //public bool Result;
        ...
        protected override void OnDoWork(DoWorkEventArgs e)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    //        var parameterizedThreadsList =
                    //            new ezFixUpParallel.ParameterizedThreadsList<FacebookHelper.FacebookFriendData>(
                    //                fbFriendsDataList,
                    ...
                    //    var parameterizedThreadsList =
                    //        new ezFixUpParallel.ParameterizedThreadsList<string>(ftu.Usernames, ftu.TakenUsernames,
                    ...
                    //            new ezFixUpParallel.ParameterizedThreadsList<FacebookHelper.FacebookFriendDataClass>(
        ...
        private delegate void FacebookFriendsWorkerEventHandler(ezFixUpFacebookApp facebook, HttpContext context, AsyncOperation asyncOp);
        ...
        private static void ProcessFacebookFriendsAsync(HttpContext context, object taskId)
        {
            ...
            ezFixUpFacebookApp facebook = taskId as ezFixUpFacebookApp;
            bool toInvoke = true;
        ...
        private static void FacebookFriendsWorker(ezFixUpFacebookApp facebook, HttpContext context, AsyncOperation asyncOp)
        {
            AddFriendsWithMutualFriends(facebook, context);
            AddFriendsWithoutMutualFriends(facebook, context);
            FetchAndSaveFacebookMutualFriends(facebook, context);
        ...
        private static void FetchAndSaveFacebookMutualFriends(ezFixUpFacebookApp facebook, HttpContext context)
        {
        ...
        public static void AddFriendsWithMutualFriends(ezFixUpFacebookApp facebook, HttpContext context)
        {
            try
            {
                var mfDic = context.GetFacebookMutualFriendsDic();
        ...
        public static void AddFriendsWithoutMutualFriends(ezFixUpFacebookApp facebook, HttpContext context)
        {
            try
            {
                var mfDic = context.GetFacebookMutualFriendsDic();
