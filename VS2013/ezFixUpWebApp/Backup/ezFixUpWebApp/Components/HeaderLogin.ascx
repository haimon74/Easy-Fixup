...
<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="HeaderLogin.ascx.cs"
    Inherits="ezFixUp.Components.HeaderLogin" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<script type="text/javascript">
    ...
    <asp:Panel ID="pnlLogin" runat="server" DefaultButton="fbLogin" CssClass="fr">
            ...
            <tr>
                ...
                <td>
                    <div class="LoginModes">
                        ...
                        <asp:CheckBox ID="cbRememberMe" TabIndex="4" CssClass="fl" runat="server" />
                    </div>
                </td>
                <td></td>
                <td>
                    <uc1:FlexButton ID="fbForgotPassword" runat="server" TabIndex="6" SkinID="ForgotPassword"
                                    CssClass="PassLink fl" OnClick="fbForgotPassword_Click" />
                </td>
                <td>
