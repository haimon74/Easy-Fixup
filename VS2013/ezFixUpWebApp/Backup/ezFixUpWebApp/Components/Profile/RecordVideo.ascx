<%@ Control Language="c#" AutoEventWireup="True" Codebehind="RecordVideo.ascx.cs" Inherits="ezFixUp.Components.Profile.RecordVideo" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
