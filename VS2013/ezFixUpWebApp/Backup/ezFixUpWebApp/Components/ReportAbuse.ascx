<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReportAbuse.ascx.cs" Inherits="ezFixUp.Components.ReportAbuse" %>
<%@ Register TagPrefix="cv" Namespace="ezFixUp.Components" Assembly="ezFixUpWebApp" %>
