...
namespace ezFixUp.Components.WebParts
{
    ...
    public partial class MyProfileWebPart : WebPartUserControl
    {
        ...
        {
            Global.GetSessionState()["BroadcastingUsersSearch"] = true;
