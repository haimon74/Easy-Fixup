<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InviteFriendsFromFacebook.aspx.cs" Inherits="ezFixUp.InviteFriendsFromFacebook" %>
            ...
            <script type="text/fbml">
              <fb:fbml>
                  <fb:request-form
                            ...
                            method="POST"
                            invite="true"
                            type='<%= "ezFixUp".Translate() %>'
                            content="<%= "This is an invitation from https://ezFixUp.com".Translate() %>
                         <% = Server.HtmlEncode("<fb:req-choice url=\"" +Config.Urls.Home + "/home.aspx" + "\" label=\"Confirm\" />")  %> " >
                            <fb:multi-friend-selector
                            rows="15"
                            cols="4"
                            bypass="cancel"
                            showborder="true"
                            actiontext="<%= "Invite your friends to use ezFixUp.".Translate() %>">
                </fb:request-form>
              </fb:fbml>
            </script>
        </fb:serverfbml>
