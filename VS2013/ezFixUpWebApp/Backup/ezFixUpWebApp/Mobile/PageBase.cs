    ...
    public class PageBase : InternalPage
    {
        ...
        public new UserSession CurrentUserSession
        {
            ...
            set
            {
                ...
                {
                    if (Global.GetSessionState()["LanguageIdExplicit"] == null
                    || (bool)Global.GetSessionState()["LanguageIdExplicit"] == false)
                    {
        ...
        {
            set { Global.GetSessionState()["ShowStatus_LinkURL"] = value; }
            get
            {
                if (Global.GetSessionState()["ShowStatus_LinkURL"] == null)
                    return null;
                else
                    return (string)Global.GetSessionState()["ShowStatus_LinkURL"];
            }
        }
        ...
        {
            set { Global.GetSessionState()["ShowStatus_LinkText"] = value; }
            get
            {
                if (Global.GetSessionState()["ShowStatus_LinkText"] == null)
                    return null;
                else
                    return (string)Global.GetSessionState()["ShowStatus_LinkText"];
            }
        }
        ...
        {
            set { Global.GetSessionState()["ShowStatus_LinkSkindId"] = value; }
            get
            {
                if (Global.GetSessionState()["ShowStatus_LinkSkindId"] == null)
                    return null;
                else
                    return (string)Global.GetSessionState()["ShowStatus_LinkSkindId"];
            }
        }
        ...
        public int LanguageId
        {
            set
            {
                Global.GetSessionState()["LanguageId"] = value;
        ...
        private void CommunityFaceControlValidation()
        {
            if (CurrentUserSession != null)
            {
                ...
                if (Config.CommunityFaceControlSystem.EnableCommunityFaceControl
                    ...
                    && !(Page is ManageMemberProfile) && !(Page is ShowStatus))
                {
