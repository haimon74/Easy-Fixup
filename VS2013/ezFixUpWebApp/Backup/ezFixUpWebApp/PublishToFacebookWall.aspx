<%@ Page Title="" 
         ...
         Inherits="ezFixUp.PublishToFacebookWall" %>
...
<div id="divFacebook" runat="server" style="height:500px;">
    ...
    <script type="text/javascript">
        FB.init({
            appId: "<%= ezFixUp.Classes.FacebookHelper.ApiKey %>",
            status: true, // check login status
            cookie: true, // enable cookies to allow the server to access the session
            xfbml: true, // parse XFBML
            channelURL: 'https://WWW.ezFixUp.COM/channel.html', // channel.html file
    ...
    <div id="divFacebookPermission" style="width: 90%;" runat="server" visible="true">
        ...
        <div class="fb-send" data-href="https://ezFixUp.com" data-font="arial"></div>--%>
                ...
                FB.ui(
                  {
                      method: 'feed',
                      name: 'ezFixUp Link',
                      link: 'https://apps.facebook.com/ezFixUp/home.aspx',
                      //picture: 'https://apps.facebook.com/ezFixUp_local/favicon.ico',
                      caption: 'ezFixUp',
                      description: 'Here is my invitation to the great application of ezFixUp.'
                  },
                  function(response) {
...
//            {
//                      method: 'send',
//                      name: 'Enjoying at ezFixUp',
//                      link: 'https://apps.facebook.com/ezFixUp_local/home.aspx'//'https://ezFixUp.com'
//                  },
