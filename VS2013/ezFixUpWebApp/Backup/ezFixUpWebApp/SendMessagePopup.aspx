<%@ Page Language="c#" CodeBehind="SendMessagePopup.aspx.cs"
    AutoEventWireup="True" Inherits="ezFixUp.SendMessagePopup" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var ezFixUpJqueryLoaded = false;
        var popeyeLoaded = false;
        function waitToLoadJQueryDependentScripts() {
            // Script that does something and depends on jQuery being there.
            if (window.$ && jQuery) {
                $(window).load(function () {
                    loadScriptNonBlockingWay('./scripts/jquery.ezFixUp.min.js');
...
<% if (Global.GetSessionState()["Direction"] == "rtl")
    {%>
...
<ajaxToolkit:ToolkitScriptManager ID="ScriptManagerMaster" CombineScripts="true" ScriptMode="Release" CompositeScript-ScriptMode="Release" LoadScriptsBeforeUI="false"  
        ...
        <CompositeScript ScriptMode="Release">
            <Scripts>
	            ...
	            <asp:ScriptReference name="CascadingDropDown.CascadingDropDownBehavior.js" assembly="AjaxControlToolkit, Version=4.1.60919.0, Culture=neutral, PublicKeyToken=28f01b0e84b6d53e"/>
    ...
    <div id="main">
        ...
        <div id='msgSentResult' runat="server" visible="false">
            <div id='actionResultIcon' style='margin:0 auto;width:118px;height:128px;background:url(./images/msg_sent.png);'>
            </div>
            <br />
            <div style='text-align:center;width:100%;'>
                <label id='lblMsgSent' runat="server" style='color:FireBrick;font-size:large;text-transform:uppercase;'>
                    <%# "Your message has been sent successfuly".Translate().ToUpper() %>
                </label>
            </div>
        </div>
