<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShowAd.aspx.cs" Inherits="ezFixUp.ShowAd" %>
                        ...
                        <table class="thumbs-wrap" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td align="center" valign="middle">
									...
									<%# ezFixUp.AdPhoto.RenderImageTag((int)Eval("ID"), 90, 90, "photoframe", true) %></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </ItemTemplate>
