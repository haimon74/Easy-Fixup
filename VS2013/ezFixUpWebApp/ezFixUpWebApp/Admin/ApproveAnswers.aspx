<%@ Page language="c#" Codebehind="ApproveAnswers.aspx.cs" AutoEventWireup="True" Inherits="ezFixUp.Admin.ApproveAnswers" %>
					...
					CssClass="btable1" cellpadding="0" cellspacing="0"  BorderWidth="0" GridLines="None">
						...
						<Columns>
							<asp:TemplateColumn>
								...
								<ItemTemplate>
								<a target="_blank" href="<%= ezFixUp.Classes.Config.Urls.Home%>/ShowUser.aspx?uid=<%# Eval("Username")%>"><%# Eval("Username")%></a>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn>
