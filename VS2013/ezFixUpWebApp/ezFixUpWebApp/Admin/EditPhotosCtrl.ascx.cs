    ...
    public partial class EditPhotosCtrl : UserControl
    {
        ...
        private class IndexedPhotos
        {
            ...
            public Photo this[string photoID]
            {
                get
                {
                    if (Global.GetSessionState()["temp_photos"] == null)
                        return null;
                    else
                        sortedList = (SortedList) Global.GetSessionState()["temp_photos"];
                ...
                set
                {
                    ...
                    Global.GetSessionState()["temp_photos"] = sortedList;
                }
            }
            ...
            public void Clear()
            {
                Global.GetSessionState()["temp_photos"] = null;
            }
