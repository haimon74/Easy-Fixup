...
namespace ezFixUp.Classes
{
    ...
    public class GroupEvent
    {
        ...
        private static GroupEvent[] Fetch(int? id, int? groupID, string username, DateTime? fromDate, DateTime? toDate, int? numberOfGroupEvents, eSortColumn sortColumn)
        {
            ...
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchGroupEvents", id, groupID, username, fromDate, toDate, numberOfGroupEvents, sortColumn);
                                    ...
                                    string keyword, DateTime? fromDate, DateTime? toDate, string groupMember, int? numberOfGroupEvents, eSortColumn sortColumn)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "SearchGroupEvents",
        ...
        public static Hashtable FetchNumberOfUpcomingEvents(string username)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchNumberOfUpcomingEvents", username);
        ...
        public static Image LoadImage(int groupEventID)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader)
                    SqlHelper.GetDB().ExecuteReader( "FetchGroupEventImage", groupEventID);
        ...
        private static string[] FetchAttenders(int? groupEventID, string username)
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "FetchGroupEventsAttenders", groupEventID, username);
