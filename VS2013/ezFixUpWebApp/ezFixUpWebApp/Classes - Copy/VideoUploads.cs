...
namespace ezFixUp.Classes
{
    public class VideoUpload
    {
        ...
        public void Save()
        {
            ...
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveVideoUpload", id, username, processed, approved, isPrivate);
        ...
        public static List<VideoUpload> Load(int? id, string username, bool? processed, bool? approved, bool? isPrivate, int? numberOfVideos)
        {
            ...
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlDataReader reader = (SqlDataReader) SqlHelper.GetDB().ExecuteReader( "LoadVideoUploads", id,
        ...
        public void Delete()
        {
            using (SqlConnection conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteVideoUpload", id);
            }
