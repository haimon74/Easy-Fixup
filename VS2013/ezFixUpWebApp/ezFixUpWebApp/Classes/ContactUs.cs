    ...
    public class ContactUs
    {
            ...
            )
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("SearchContactUs",
                                                                    reportedBy, reportedUser, type, reportedId,
                                                                    reviewed, dateReportedFrom, dateReportedTo,
                                                                    sortColumn))
                {
        ...
        public static ContactUs Fetch(int id)
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("LoadContactUs", id))
                {
        ...
        public void Save()
        {
            //using (var conn = Config.DB.Open())
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveContactUs", id,
