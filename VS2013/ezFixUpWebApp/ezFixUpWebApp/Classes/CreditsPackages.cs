    ...
    public class CreditsPackage
    {
        ...
        private static CreditsPackage[] Fetch(int? id, string name, int? quantity, decimal? price, eSortColumn sortColumn)
        {
            //using (var conn = Config.DB.Open())
            {
                ...
                using (var reader = SqlHelper.GetDB().ExecuteReader("FetchCreditsPackages",
                                                                    id, name, quantity, price, sortColumn))
                {
        ...
        public void Save()
        {
            //using (var conn = Config.DB.Open())
            {
                object result = SqlHelper.GetDB().ExecuteScalar( "SaveCreditsPackage", id, name, quantity, price);
        ...
        public static void Delete(int id)
        {
            //using (var conn = Config.DB.Open())
            {
                SqlHelper.GetDB().ExecuteNonQuery( "DeleteCreditsPackage", id);
            }
        }
