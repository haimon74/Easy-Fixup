...
namespace Microsoft.IdentityModel.TokenProcessor
{
    public class Token
    {
        ...
        private static int[] TripleDes =  { "https://www.w3.org/2001/04/xmlenc#tripledes-cbc".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#kw-tripledes".GetHashCode() };
        private static int[] Aes = { "https://www.w3.org/2001/04/xmlenc#aes128-cbc".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#aes192-cbc".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#aes256-cbc".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#kw-aes128".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#kw-aes192".GetHashCode(), "https://www.w3.org/2001/04/xmlenc#kw-aes256".GetHashCode() };

        static class XmlEncryptionStrings
        {
            public const string Namespace = "https://www.w3.org/2001/04/xmlenc#";
        ...
        {
            public const string Namespace = "https://www.w3.org/2000/09/xmldsig#";
        ...
        {
            public const string Namespace = "https://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd";
