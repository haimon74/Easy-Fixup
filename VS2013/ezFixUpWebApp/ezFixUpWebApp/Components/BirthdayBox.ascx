...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="BirthdayBox.ascx.cs" Inherits="ezFixUp.Components.BirthdayBox" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
