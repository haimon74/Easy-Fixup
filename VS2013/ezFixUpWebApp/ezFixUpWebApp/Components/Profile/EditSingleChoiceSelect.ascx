<%@ Control Language="c#" AutoEventWireup="True" Codebehind="EditSingleChoiceSelect.ascx.cs" Inherits="ezFixUp.Components.Profile.EditSingleChoiceSelect" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
