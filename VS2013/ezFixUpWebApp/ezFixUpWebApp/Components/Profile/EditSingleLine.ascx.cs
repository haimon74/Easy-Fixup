    ...
    public partial class EditSingleLine : UserControl, IProfileQuestionComponent, ICascadeQuestionComponent
    {
        ...
        public string Description
        {
            ...
            { 
                ...
                lblDescription.Visible = lblDescription.Text.Length > 3;
            }
        }
        ...
        public string Hint
        {
            ...
            {
                lblHint.Text = value ?? "";
                lblHint.Visible = lblDescription.Text.Length > 3;
            }
        }
        ...
        public ProfileQuestion Question
        {
            set
            {
                ...
                {
                    lblName.Text = Lang.Trans(value.Name);
            ...
            get
            {
                ...
                if (Value.Trim().Length == 0)
                {
                    if (required && !adminMode)
                        ...
                        throw new AnswerRequiredException(lblName.Text );
                    else
                    {
                        answer.Value = "";
                        return answer;
