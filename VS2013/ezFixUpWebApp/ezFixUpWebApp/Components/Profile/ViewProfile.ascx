...
<%@ Control Language="c#" 
            ...
            Inherits="ezFixUp.Components.Profile.ViewProfile" 
            ...
            <tr>
                ...
                <td valign="top" width="40%" class="skincolor">
                    ...
                    <div id="pnlInterestedIn" runat="server" visible="false" style='display:none;'>
                        <span class="label skincolor ">
                            <%= ((Page as PageBase).CurrentUserSession.InterestedIn != ezFixUp.Classes.User.eGender.Matchmaker) ? Lang.Trans("Interested In") : "" %></span>:
