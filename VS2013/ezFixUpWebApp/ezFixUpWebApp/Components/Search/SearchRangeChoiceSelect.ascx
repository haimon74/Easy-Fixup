...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="SearchRangeChoiceSelect.ascx.cs" Inherits="ezFixUp.Components.Search.SearchRangeChoiceSelect" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
