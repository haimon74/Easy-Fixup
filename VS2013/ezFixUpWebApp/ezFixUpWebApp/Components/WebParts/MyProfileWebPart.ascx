<%@ Control Language="C#" 
            ...
            Inherits="ezFixUp.Components.WebParts.MyProfileWebPart" %>
...
<div class="MyProfileContent">
    ...
    <div id="divFaceBookStatusUpdate" visible="false" runat="server">
        ...
        <%--<script type="text/javascript">
            FB.init("<%= ezFixUp.Classes.FacebookHelper.ApiKey %>", "Facebook/xd_receiver.htm", { permsToRequestOnConnect: "publish_stream" });
        </script>--%>
