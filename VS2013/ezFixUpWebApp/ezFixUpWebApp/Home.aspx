<%@ Page Language="c#" MasterPageFile="Site.Master" CodeBehind="Home.aspx.cs" AutoEventWireup="True"
    Inherits="ezFixUp.Home" Async="true" AsyncTimeout="120"  %>
...
<%--        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
            ...
            <ContentTemplate>--%>
                <CustomWebPartZone:CustomWebPartZone BorderStyle="None" BorderWidth="0"  Padding="0"
...
<%--                </ContentTemplate>
         ...
         <asp:UpdatePanel ID="upLeftCatalogButton" runat="server">
            ...
            <ContentTemplate>
                <div class="mode">
                   <u><asp:LinkButton ID="lnkCatalogForLeftParts" runat="server"  Font-Size="Small" Font-Bold="false"
                        CssClass="fr" OnClick="lnkCatalogForLeftParts_Click"></asp:LinkButton></u>
                </div>                
    ...
    <div id="main">
        ...
        <asp:UpdatePanel ID="upCatalog" runat="server">
         ...
         <asp:UpdatePanel ID="upRightCatalogButton" runat="server">
            ...
            <ContentTemplate>
                <div class="mode">
                    <u><asp:LinkButton ID="lnkCatalogForRightParts" runat="server" Font-Size="Small" Font-Bold="false"
                        CssClass="fr" OnClick="lnkCatalogForRightParts_Click"></asp:LinkButton></u>
                </div>                
