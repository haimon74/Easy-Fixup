<%@ Page Language="c#" MasterPageFile="Site.Master" CodeBehind="InviteFriends.aspx.cs"
    AutoEventWireup="True" Inherits="ezFixUp.InviteFriends" %>
        ...
        <div id="divFacebook" runat="server">
            <script type="text/javascript">
                ...
                function getDialogFbml() {
                    ...
                    '          <fb:fbml>' +
                    '              <fb:request-form' +
                    '                action=\"https://apps.facebook.com/ezFixUp/default.aspx\"' +
                    '                method="POST"' +
                    '                invite="true"' +
                    //'                target="_top"' +
                    //'                email_invite="true"' +
                    "                type='ezFixUp'" +
                    "                content='This is an invitation from https://ezFixUp.com" +
                    "                         <fb:req-choice url=\"https://ezFixUp.com/default.aspx\" label=\"OK\" />' >" +
                    '                <fb:multi-friend-selector rows="15" cols="4" max="80" bypass="cancel" showborder="true"' +
                    '                    actiontext="Invite your friends to use ezFixUp."' +
                ...
                function postToFeed() {
                    ...
                    var obj = {
                        method: 'feed',
                        link: 'https://ezFixUp.com',
                        picture: 'ezFixUp.com/Images/logo.png',
                        name: 'ezFixUp Feed',
                        caption: 'ezFixUp - Is time to update your status.',
                        description: 'Join me to the great Application ezFixUp, which help you to matchmaking between your friends. Inviting 10 Friends will give you 1 month of premium membership'
                    };
                ...
                function sendRequestToManyRecipients(filterBy) {                    
                    ...
                    FB.api(inviteQry, function (response) {
                            ...
                            for (var i = 0; i < response.length && i<50; i++) {
                            ...
                            var obj = {
                                ...
                                to: strUIDs,
                                link: 'https://ezFixUp.com',
                                title: invite_title, //'ezFixUp - Is time to update your status.',
                                message:  invite_message,//'Invite you friends to ezFixUp on Facebook: 10 Friends that will join will give you 1 month of premium membership',
                                filters : ["app_non_users"],
                ...
                function sendMessageToManyRecipients() {
                    var obj = { method: 'send', //'apprequests',
                        app_id: "<%= FacebookHelper.ApiKey%>",
                        name: 'ezFixUp - Is time to update your status.',
            ...
            <div style="clear:both;">
                ...
                <div id="accordion">
                    ...
                    <div style='height: 250px !important;'>
                        ...
                        <br />
                        <br />
                        <div class="fb-like" data-href="https://ezFixUp.com" data-send="true" data-width="400"
                            data-show-faces="true" data-font="arial" data-lang='he_IL' data-locale='he-IL'>
                        </div>
                        <script type="text/javascript">
                            jQuery(function ($) {
                                $(".fb-like").attr('data-href', 'https://ezFixUp.com?invitedBy=' + '<%= GetCurrentUserSession().Username %>');
                            });
                        </script>
                        <br />
                    </div>
