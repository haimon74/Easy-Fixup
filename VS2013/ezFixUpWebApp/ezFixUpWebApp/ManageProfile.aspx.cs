...
using ezFixUp.Components.Profile;
...
namespace ezFixUp
{
    public partial class ManageMemberProfile : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LoadStrings();
            Global.GetSessionState()["CurrentRawUrl"] = Request.Url.Authority + Request.Url.LocalPath;
            ...
            if (!Page.IsPostBack)
            {
                ...
                //    sw.Flush();
                //    Global.GetSessionState()["ManageProfile.aspx"] = new StringWriter();
                //    Response.End();
                //}
                //else
                {
