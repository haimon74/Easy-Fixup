...
namespace ezFixUp
{
    public partial class Registration : PageBase
    {
        ...
        private string PrimaryPhotoURL
        {
            get
            {
                return (Global.GetSessionState().ContainsKey("PrimaryPhotoURL")) ? Global.GetSessionState()["PrimaryPhotoURL"] as string : null;
            }

            set
            {
                Global.GetSessionState()["PrimaryPhotoURL"] = value;
            }
        }
        ...
        {
            Global.GetSessionState()["IsRegistrationFormValidated"] = null;
        ...
        {
            Token token = null;
            if (Global.GetSessionState().ContainsKey("Token"))
            {
                token = Global.GetSessionState()["Token"] as Token;
            }
        ...
        private void PrepareStrings()
        {
            ...
            var countries1 = Services.Service.GetCountries(true);
            //var countries2 = Config.Users.GetCountries();
            string ip = Request.UserHostAddress;
            string ip2country = IPToCountry.GetCountry(ip);
            string defaultCountry =  ip2country ?? "ישראל";
            foreach (var country in countries1)
            {
                dropCountry.Items.Add(new ListItem(country.name,country.value));
            }

            //dropCountry.DataSource = countries1;
        ...
        {
            get { return Global.GetSessionState().ContainsKey("LastAsyncFileUploadLocation") ? (string)Global.GetSessionState()["LastAsyncFileUploadLocation"] : "Images/default_male.png"; }
            set { Global.GetSessionState()["LastAsyncFileUploadLocation"] = value ?? "Images/default_male.png"; }
        }
        ...
        protected void ResponseEndWithErrorMessage(string message)
        {
            ...
            lblError.Font.Size = FontUnit.Large;
        ...
        protected void dropCountrySelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (regions != null)
            {
                ...
                dropCity.Items.Add("Select Region first");
