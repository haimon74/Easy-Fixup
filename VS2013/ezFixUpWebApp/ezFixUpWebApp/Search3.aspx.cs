    ...
    public partial class Search3 : PageBase
    {
            ...
            protected void ExecuteAsyncTask()
            {
                lock (this.ItsSearchPageContext.SearchResults)
                {
                    ...
                    //if (ItsSearchPageContext.Page.IsPostBack)
                    {
                        ...
                        Global.GetSessionState(ItsSearchPageContext.sessionId)["advancedSearch"] = false;
        ...
        private void PrepareDefaultFields()
        {
            //if (CurrentUserSession != null)
            {
                ...
                {
                    BasicSearch sessionSearch = (BasicSearch)Global.GetSessionState(sessionId)["SessionSearchRequest"];
        ...
        private void LoadStrings()
        {
            ...
            int langId = Global.GetSessionState(sessionId).ContainsKey("LanguageId") ? (int)Global.GetSessionState(sessionId)["LanguageId"] : Config.Misc.DefaultLanguageId;
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                BasicSearch search = ((bool)Global.GetSessionState(sessionId)["advancedSearch"]) ? new CustomSearch() : new BasicSearch();
        ...
        protected void lnkQuickSearch_Click(object sender, EventArgs e)
        {
            ...
            Global.GetSessionState(sessionId)["advancedSearch"] = false;
            ...
            //    if (Request.Params["loc"] == "session")
            //    {
            //        BasicSearch sessionSearch = (BasicSearch)Global.GetSessionState()["SessionSearchRequest"];
        ...
        protected void lnkAdvancedSearch_Click(object sender, EventArgs e)
        {
            if (HttpContext.Current == null)
                HttpContext.Current = itsContext;
            Global.GetSessionState(sessionId)["advancedSearch"] = true;
        ...
        private void ProcessMenuButtonClick(LinkButton linkButton, string searchTitle, string resultTitle, bool needAuthorization)
        {
            ...
            hfDisplayAdvancedSearch.Value = Global.GetSessionState(sessionId)["advancedSearch"].ToString();
